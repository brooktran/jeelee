 ...
 * terms.
 */
package org.jtool.sample.binaryEdit;
 ...
 * 
 */
public class BEViewAction extends AppAction{
	private static final long serialVersionUID = 1L;
	public static final String ID = "BEView";
	 ...
	 * @param app
	 */
	public BEViewAction(IApplication app) {
		super(app,ID);
	...
	public void actionPerformed(ActionEvent e) {
		...
		IView view = new BinaryEditorView();
