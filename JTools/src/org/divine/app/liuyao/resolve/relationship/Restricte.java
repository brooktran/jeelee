 ...
 * 
 */
public class Restricte extends AbstractRelationship {

	/**
	 * @param hight
	 * @param strength
	 */
	public Restricte(Item hight, Item low) {
		super(hight,low);
	}
	...
	public int getStrength() {
		return (int )(low.getStrength()- hight.getStrength() *AbstractRelationship.StrengthRestricte);
	}
}
