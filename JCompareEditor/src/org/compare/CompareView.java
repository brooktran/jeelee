 ...
 * 
 */
public class CompareView extends AbsView {
	...
	public CompareView() {
		...
		resource.configView(this, "compare");
		initComponents();
	...
	/**
	 * Update the caret labels while the focus changes.
	 */
	private void caretUpdate(CaretEvent e) {
		...
		try {
			...
			caretLabel.setText((line + 1) + ":" + (pos - lineStartOffset + 1));
